...
const symlinkPath = path.resolve(dataPath, "modules", "hopefinder");
...
if (symlinkStats) {
    ...
    const proceed = (
        await prompts({
            ...
            name: "value",
            initial: false,
            message: `A "hopefinder" ${atPath} already exists in the "modules" subfolder. Replace with new symlink?`,
        })
    ).value;
    if (!proceed) {
